...
public class Info {
    ...
    public void draw(Graphics g) {
        ...
        g.drawString("Frame: " + refreshCounter.toString(), 10, 25);
        g.drawString("Wall Collisions: " + wallcollisionCounter.toString(), 10, 40);
        g.drawString("Ball Collisions: " + ballcollisionCounter.toString(), 10, 55);
        g.drawString("Amount of Balls: " + ballcount, 10, 70);
        g.drawString("Lowest mass: " + minmass, 10, 85);
        g.drawString("Highest mass: " + maxmass, 10, 100);
        g.drawString("Highest speed X: " + highestspeedx, 10, 115);
        g.drawString("Highest speed Y: " + highestspeedy, 10, 130);
        g.drawString("\u00a9 Tycho Engberink " + LocalDate.now().getYear(), (int) Main.width - 140, (int) Main.height - 10);
    }
}
